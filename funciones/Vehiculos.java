   ...
   public static ArrayList<Vehiculo> lista = new ArrayList<Vehiculo>();
       ...
       public static void addToList(boolean servicioPublico) {
        ...
        if (Clientes.lista.size() <= 0){
            ...
            if (propietario != null){
                System.out.print("Tipo de vehiculo (1 - Turismo, 2 - Motocicleta) : ");
        ...
        public static void buscarVehiculo(){
            ...
            if (vehiculo != null){
                ...
                System.out.println("\t Cliente: "+vehiculo.getCliente().getNombre());
                System.out.print("\t Servicio publico: ");
                if (vehiculo.getPublico()){
